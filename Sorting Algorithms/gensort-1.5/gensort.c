...
void gen_ascii_rec(unsigned char *rec_buf, rand_queue *rq)
{
     ...
     */
    temp = rand.hi8;
    rec_buf[0] = (unsigned char)('A' + (temp % 26));
    temp /= 26;
    rec_buf[1] = (unsigned char)('A' + (temp % 26));
    temp /= 26;
    rec_buf[2] = (unsigned char)('A' + (temp % 26));
    temp /= 26;
    rec_buf[3] = (unsigned char)('A' + (temp % 26));
    temp /= 26;
    rec_buf[4] = (unsigned char)('A' + (temp % 26));
    temp /= 26;
    rec_buf[5] = (unsigned char)('A' + (temp % 26));
    temp /= 26;
    rec_buf[6] = (unsigned char)('A' + (temp % 26));
    temp /= 26;
    rec_buf[7] = (unsigned char)('A' + (temp % 26));
    temp = rand.lo8;
    rec_buf[8] = (unsigned char)('A' + (temp % 26));
    temp /= 26;
    rec_buf[9] = (unsigned char)('A' + (temp % 26));
    temp /= 26;
